...
st.sidebar.caption("Ensemble v2.1: Normalized PDF Engine + Context-Aware Windowing")
...
# Text Normalizer (Fixes PDF/DOCX formatting artifacts)
...
if st.button("Analyze Text", type="primary"):
    # Normalize input text completely
